        ...
        return (
            <Fragment>
                <Container fluid={true} className="text-center footerSection">
                    <Row>
                        <Col lg={3} md={6} sm={12} className="p-5 text-justify">
                            ...
                            <a className="socialLink" href="https://www.facebook.com/profile.php?id=100014307134284"><FontAwesomeIcon  icon={faFacebook} /> Facebook</a><br/>
                            <a className="socialLink" href="#"><FontAwesomeIcon  icon={faYoutube} /> YouTube</a>
                        </Col>
                        <Col lg={3} md={6} sm={12} className="p-5 text-justify">
                            <h1 className="serviceName">Address</h1>
                            <p className="serviceDescription" >#2/21 Bordhanbari, Mirpur-1, Dhaka - 1216, Bangladesh</p>
                            <p className="serviceDescription" > <FontAwesomeIcon  icon={faEnvelope} /> mizanurcse1452@gmail.com</p>
                            <p className="serviceDescription" > <FontAwesomeIcon  icon={faPhone} /> +8801749969029</p>
                        </Col>
                        <Col lg={3} md={6} sm={12} className="p-5 text-justify">
                ...
                <Container fluid={true} className="text-center copyrightSection">
                    <a className="copyrightLink" href="#">2020-2021 &copy; Design By Mizanur Rahaman</a>
                </Container>
